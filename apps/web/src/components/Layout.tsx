...
const NAV: NavItem[] = [
  ...
  { to: '/tracking/devices', labelKey: 'nav.trackingDevices', icon: Cpu, permission: 'assets.read', section: 'tracking' },
  { to: '/tracking/geofences', labelKey: 'nav.trackingGeofences', icon: MapPin, permission: 'assets.read', section: 'tracking' },
  { to: '/tracking/subscription', labelKey: 'nav.trackingSubscription', icon: Satellite, permission: 'assets.read', section: 'tracking' },
